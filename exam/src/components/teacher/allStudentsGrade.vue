...
<template>
  <div class="all">
    ...
    <el-pagination
      ...
      class="page"
    ></el-pagination>
    <el-button type="primary" @click="exportWord" style="float: right" icon="el-icon-download" plain>下载成绩</el-button>
  </div>

</template>

<!--<template>-->
  <!--<el-button type="primary" @click="exportWord" icon="el-icon-download" plain>下载成绩</el-button>-->
<!--</template>-->
...
export default {
  ...
  methods: {
    ...
    exportWord () {
      this.$axios.post('/api/scores/export', {}, {
        responseType: 'blob'
      }).then(res => {
        // console.log(res);
        ...
        downloadElement.download = '学生成绩.xls'; //下载后文件名
