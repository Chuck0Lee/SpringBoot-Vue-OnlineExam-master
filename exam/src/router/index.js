  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        ...
        {
          path: '/manager2',
          component: () => import ('@/components/common/manager2')
        },
        {
          path:'/answerScore',
          component: () => import('@/components/teacher/answerScore')
        },
        {
          path:'/answerExam',
          component: () => import('@/components/teacher/answerExam')
        }
      ]
    },
    {
      ...
      children: [
        {path:"/",component: ()=> import('@/components/student/mySubject')},
        {path:"/myExam",component: ()=> import('@/components/student/myExam')},
        {path:'/startExam', component: () => import('@/components/student/startExam')},
        {path:'/practiceExam', component: () => import('@/components/student/practiceExam')},
        {path:'/errorQuestion', component: () => import('@/components/student/errorQuestion')},
